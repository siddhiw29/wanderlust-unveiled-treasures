...
const popularDestinations = ['Bali', 'Kyoto', 'Marrakech', 'Santorini', 'Cartagena'];
...
const SearchHero = () => {
  ...
  return (
    <div className="hero-section bg-hero-pattern">
      <div className="container mx-auto px-4 py-24 relative z-10 text-center">
        <h1 className="text-5xl md:text-6xl font-bold mb-6 drop-shadow-md">
          Discover Hidden Treasures <br className="hidden md:block" />
          <span className="text-primary">Around the World</span>
        </h1>
        <p className="text-xl mb-8 max-w-2xl mx-auto drop-shadow-md">
          Explore authentic local experiences, undiscovered gems, and cultural treasures that make each destination unique.
        </p>
        ...
        <form onSubmit={handleSearch} className="max-w-md mx-auto mb-8">
          <div className="relative">
            <Input
              type="text"
              placeholder="Where to? Try 'Kyoto' or 'Marrakech'"
        ...
        <div className="flex flex-wrap justify-center gap-2 items-center">
          <span className="text-sm text-white/90">Popular:</span>
